...
static u32 omap44xx_sr_mpu_efuse_offs[] = {
	OMAP44XX_CONTROL_FUSE_MPU_OPPLP, OMAP44XX_CONTROL_FUSE_MPU_OPP70,
	...
	OMAP44XX_CONTROL_FUSE_MPU_OPPTXT, OMAP44XX_CONTROL_FUSE_MPU_OPPOC,
	OMAP44XX_CONTROL_FUSE_MPU_OPPTNT,
};
